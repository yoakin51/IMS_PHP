        ...
        <table class="table table-bordered">
          <thead>
            <tr>
              ...
              <th class="text-center" style="width:7%;">Low Stock
              </th>
              <th class="text-center" style="width:7%;">Over Stock
              </th>
              <th class="text-center" style="width: 6%;"> Units
              </th>
              <th class="text-center" style="width: 10%;"> Price(ETB)</th>
...
<? php endif;  */ ?>
                ...
                <td class="text-center">
                  <?php echo remove_junk($product['low_stock']); ?>
                </td>
                <td class="text-center">
                  <?php echo remove_junk($product['over_stock']); ?>
                </td>
                <td class="text-center">
                ...
                <td class="text-center">
                  <div class="btn-group">
                    <a href="edit_product.php?prod_id=<?php echo (int) $product['prod_id']; ?>"
                      class="btn btn-info btn-xs" title="Edit" data-toggle="tooltip">
                      <span class="glyphicon glyphicon-edit"></span>
                    </a>
                    <a href="delete_product.php?prod_id=<?php echo (int) $product['prod_id']; ?>"

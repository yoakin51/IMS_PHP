...
<?php foreach ($requests as $request): ?>
    ...
    <div class="container">
        ...
        <a href="../request/requisitions.php?request_id=<?php echo $buttonValue; ?>A">Approve</a>
        <a href="../request/requisitions.php?request_id=<?php echo $buttonValue; ?>D">Decline</a>
